...
"}")
        ...
        self.settingsButton.setIconSize(QtCore.QSize(64, 64))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/ack.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.acceptButton.setIcon(icon2)
        self.acceptButton.setIconSize(QtCore.QSize(64, 64))
        self.acceptButton.setObjectName("acceptButton")
        self.gridLayout.addWidget(self.acceptButton, 1, 2, 1, 1)
        ...
        self.tableView = QtWidgets.QTableView(PyIpChanger)
